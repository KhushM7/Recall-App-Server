...
from flashcard_db_operations import DatabaseOperations, Card, ReviewLog, State, Rating
...
class Card:
    def __init__(
        ...
        self.due = due if due else datetime.now()
...
class SchedulingCards:
    ...
    def schedule(
        ...
        self.hard.due = (
            now + timedelta(days=hard_interval)
            if hard_interval > 0
